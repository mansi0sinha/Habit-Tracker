...
export default function Dashboard() {
  ...
  const streaksById = useMemo(() => {
    ...
    for (const habit of habits) {
      result[habit._id] = streakFromKeys(
    ...
    return result;
  }, [habits, checkInsByHabit, timezone]);
  ...
  // SUMMARY VALUES
  // ==========================================
  const activeStreaks = Object.values(
    streaksById
  ).filter(
  ...
  const heatmap = useMemo(() => {
    ...
    const dates = last90Days(timezone);
